...
export namespace PostActions {
   ...
   export const createPostStart = createAction<PostModel>(Type.CREATE_POST_START);

   // export const fetchPostsFinish = (responsePosts: any) => ({
   //    type: Type.FETCH_POSTS_FINISH,
   //    payload: responsePosts
   // })
   export const createPostSuccess = createAction<boolean>(Type.CREATE_POST_SUCCESS);
   export const createPostFailure = createAction<any>(Type.CREATE_POST_FAILURE);
}
